...
# --- dados de fallback (se a API estiver fora) ---
weekly = pd.DataFrame([
...
st.write(
    "• **Monitoramento Climático** com ET₀ e recomendações de irrigação.  \n"
    "• **Análise por Satélite** (NDVI) com alertas de estresse.  \n"
    "• **Inteligência de Mercado** (commodities e tendências).  \n"
...
with gcol1:
    ...
    fig = px.line(weekly, x="day", y=["temp","et0"], markers=True,
...
st.info("Use o menu **Pages** (barra lateral) para acessar *Clima*, *Mercado*, etc.")
